(function () {
  ...
  function scriptHint(editor, keywords, getToken, options) {
    ...
    while (tprop.type == 'property') {
      ...
      if (tprop.string == ')') {
        ...
        tprop = getToken(editor, { line: cur.line, ch: tprop.start });
        if (tprop.type == 'variable') {tprop.type = 'function';} else return; // no clue
      }
  ...
  function getCompletions(token, context, keywords, options) {
    ...
    function gatherCompletions(obj) {
      ...
      for (const name in obj) maybeAdd(name);
    }
    ...
    if (context) {
      ...
      if (obj.type == 'variable') {
        ...
        if (window.jQuery != null && (obj.string == '$' || obj.string == 'jQuery') &&
            (typeof window.jQuery === 'function')) {base = window.jQuery();} else if (window._ != null && (obj.string == '_') && (typeof window._ === 'function')) {base = window._();}
      }
